...
const styles = {
  ...
  introText: 'text-[14px] leading-[22.75px] text-[#595c7e]',
  fieldGroup: 'gap-8',
...
export default function MyPageResetPasswordScreen() {
  ...
  return (
    <View className={styles.container}>
      ...
      <View className={styles.footer}>
        <Pressable className={styles.submitButton} onPress={() => router.push('/mypage/reset-password-verify')}>

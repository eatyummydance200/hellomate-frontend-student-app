...
export default function NoticeDetailScreen() {
  ...
  return (
    <View className="flex-1 bg-background">
      ...
      <ScrollView
        className="flex-1"
        contentContainerClassName="gap-16 px-[18px] pt-16"
        showsVerticalScrollIndicator={false}
      >
        <View className="w-full gap-8 rounded-sm bg-background p-16 shadow-sm">
          <View className="flex-row items-center justify-between gap-8">
            ...
            <View
              ...
              style={{ backgroundColor: 'rgba(164,179,255,0.2)' }}
            >
              <Text className="text-[10px] leading-[24px] text-[#1c1e1e]">국제교류처</Text>
            </View>
          </View>
        ...
        <View className="w-full rounded-sm bg-background p-16 shadow-sm">
          <Text weight="medium" color="strong" className="text-[15px] leading-[26px]">
            안녕하세요. 국제교류처입니다.
          </Text>
          <Text weight="medium" color="strong" className="text-[15px] leading-[26px]">
        ...
        <View className="w-full flex-row items-center justify-between rounded-lg border border-border-strong/30 bg-background p-16 shadow-sm">
          <View>
          ...
          <Pressable className="h-32 w-32 items-center justify-center rounded-full">
            <Image source={downloadIcon} style={{ width: 16, height: 16 }} />
          </Pressable>
        </View>
      </ScrollView>

      <View className="px-[18px] pb-20 pt-8">
        <Pressable
          className="h-[52px] w-full flex-row items-center justify-center gap-8 rounded-lg bg-primary"
          onPress={() => router.push('/notice/contact')}
        >

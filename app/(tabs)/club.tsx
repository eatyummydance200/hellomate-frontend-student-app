...
const styles = {
  ...
  allScroll: 'flex-1',
  allScrollContent: 'gap-[18px] px-16 pb-32 pt-16',
  heroBanner: 'h-[96px] overflow-hidden rounded-xl bg-primary-light/20',
  ...
  searchBox: 'h-[40px] flex-row items-center justify-between rounded-sm border border-border bg-background px-12 py-8',
  ...
  clubList: 'gap-16',
  clubCard: 'w-full gap-16 rounded-xl border border-border-strong/30 bg-background p-[18px] shadow-sm',
  ...
  progressTrack: 'h-[6px] overflow-hidden rounded-full bg-[#e3eae5]',
  deadlineRow: 'flex-row items-center gap-[7px] pt-4',
  deadlineText: 'text-[13px] leading-[24px] text-text',
  mineScroll: 'flex-1',
  mineScrollContent: 'gap-[13px] px-16 pb-32 pt-24',
  ...
  leaveButton: 'h-32 items-center justify-center rounded-md border border-[#6f6f6f] px-[14px]',
  leaveButtonLabel: 'text-[13px] leading-[16px] text-[#6f6f6f]',
  exploreMoreCard: 'items-center gap-8 rounded-xl border-2 border-dashed border-primary/30 bg-primary-light/10 px-[26px] pb-[26px] pt-[34px]',
  exploreMoreTitle: 'text-[17px] leading-[22px] text-text-strong',
  exploreMoreDesc: 'text-[14px] leading-[20px] text-text',
  exploreMoreCta: 'rounded-full border border-primary bg-[#f5fbf6] px-[33px] py-[11px]',
  exploreMoreCtaText: 'text-[13px] leading-[16px] text-primary',
} as const;

const tabButton = tv({
  base: 'h-[40px] flex-1 items-center justify-center border-b',
  variants: {
    active: {
